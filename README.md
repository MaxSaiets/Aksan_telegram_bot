...
- each new YouTube description is generated by OpenAI when `OPENAI_API_KEY` is configured; an offline varied fallback keeps uploads working during an API outage
